 ...
 */
final class Version20220707052628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, cat_id INT DEFAULT NULL, pro_name VARCHAR(255) NOT NULL, price INT NOT NULL, old_price INT NOT NULL, pro_desc VARCHAR(500) NOT NULL, pro_date DATE NOT NULL, pro_qty INT NOT NULL, pro_image VARCHAR(255) NOT NULL, INDEX IDX_D34A04ADE6ADA943 (cat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
