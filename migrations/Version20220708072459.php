 ...
 */
final class Version20220708072459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, cust_name VARCHAR(255) NOT NULL, gender TINYINT(1) NOT NULL, address VARCHAR(500) NOT NULL, telephone VARCHAR(20) NOT NULL, birthday DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
